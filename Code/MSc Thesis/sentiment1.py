...
##################################################################################
    ...
    #results.append(benchmark(KNeighborsClassifier(n_neighbors=3)))
    #for penalty in ["l2", "l1"]:	
    	#results.append(benchmark(LinearSVC(loss='l2', penalty=penalty,dual=False, tol=1e-3))[1])
    ...
    #print('=' * 80)
    #print("Naive Bayes")
    #results.append(benchmark(MultinomialNB(alpha=.01))[1])
